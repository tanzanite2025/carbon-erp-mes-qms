...
export function getAppUrl() {
  ...
  // instead of the hardcoded localhost:4000 fallback.
  return ERP_URL ?? "http://localhost:4000";
}
...
export function getMESUrl() {
  ...
  // Honor it so cross-app sidebar links resolve to the portless hostname
  // instead of the hardcoded localhost:4001 fallback.
  return MES_URL ?? "http://localhost:4001";
}
